...
export const FeedbackSystem = ({
  ...
  const [timeLeft, setTimeLeft] = useState(autoAdvance ? Math.ceil(autoAdvanceDelay / 1000) : 0);

  // Auto-advance countdown
  useEffect(() => {
    if (!autoAdvance || !feedback || !onContinue) return;
  ...
  }, [autoAdvance, feedback, onContinue]);
