...
function ProfilePage() {
  ...
  const renderRoleBadge = () => {
    ...
    return (
      <Badge className={`${roleColors[auth?.user?.role]} capitalize`}>
        {auth?.user?.role}
      </Badge>
    );
  };
        ...
        return (
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card className="stats-card">
              ...
              <p className="text-2xl font-bold text-foreground">{roleStats.enrolledCourses}</p>
            </Card>
            <Card className="stats-card">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <p className="text-2xl font-bold text-foreground">{roleStats.completedCourses}</p>
            </Card>
            <Card className="stats-card">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Award className="h-4 w-4 text-primary" />
              ...
              <p className="text-2xl font-bold text-foreground">{roleStats.certificates}</p>
            </Card>
            <Card className="stats-card">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <p className="text-2xl font-bold text-foreground">{roleStats.progress}%</p>
            </Card>
          </div>
        );
        ...
        return (
          <div className="grid gap-4 md:grid-cols-3">
            <Card className="stats-card">
              ...
              <p className="text-2xl font-bold text-foreground">{roleStats.totalUsers}</p>
            </Card>
            <Card className="stats-card">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <BookOpen className="h-4 w-4 text-primary" />
              ...
              <p className="text-2xl font-bold text-foreground">{roleStats.totalCourses}</p>
            </Card>
            <Card className="stats-card">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <p className="text-2xl font-bold text-foreground">{roleStats.systemHealth}</p>
            </Card>
          </div>
        );
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 rounded-lg border p-3">
                    <div className="h-2 w-2 rounded-full bg-primary"></div>
                    <div className="flex-1">
                      <p className="text-sm font-medium">Earned Certificate in JavaScript</p>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Get notified about course progress and deadlines</p>
                  </div>
                  <Switch
